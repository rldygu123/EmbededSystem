...
/*************************************CALCULATING THE INDICES******************************************/       
     ...
     /*  printf("dep%d",dep) */;
      ...
      if(check!=0)
      {
       ...
       char king = chess[k][l] / 10;

       if(checker%2 !=0 && chess[i][j] % 10=='2')
       { 
         error=1;
         printf("PLAYER 1 YOU CANNOT ACCESS ARMY OF PLAYER 2\n");
       }  

       else if(checker%2 ==0 && chess[i][j] % 10== '1')
       {
         error=1;
     ...
     switch(ent1)
      {
       case '1':/************************************* RULES FOR PAWN************************************************/ 
        	...
        	case'1': /*CHECKS WHETHER PAWN IS AVAILABLE OR NOT*/
                {
                  if (chess[i1][j1] % 10 =='1')/*FOR UPPER PLAYER*/
                  {
                       if( (chess[k1][l1] % 10 == '1' && l1==j1) || (i1 == 1 && chess[2][j1] % 10  == '1' && j1==l1 ) ) 
                        {
                         q=1;
                         if(cond == 0)  
                       ...
                       else
                       {
                           ...
                           {                                               
                                if(chess[k1][l1] == ' ')
                                   {
                                   chess[k1][l1] / 10 == chess[i1][j1] / 10;		//기물식별
                                   chess[k1][l1] % 10 == chess[i1][j1] % 10;		//피아식별
                                   chess[i1][j1] / 10 == chess[i1][j1] % 10 ==' ';
                                   }
		  ...
		  else if (chess[i1][j1] % 10=='2')/*FOR LOWER PLAYER*/
                  {
                        if( (chess[k1][l1] % 10== '2' && l1 == j1) || (i1==6 && chess[5][j1] % 10 == '2' && j1==l1 ) )
                        {
                         q=1;
                         if(cond == 0)  
                       ...
                       else
                       {
                           if ( i1==6 && (k1==i1-1 || k1==i1-2) && l1==j1 )/*WHEN THE PAWN IS AT ITS INITIAL POSITION*/
                           {
                                if(chess[k1][l1] == ' ')
                                   ...
                                   chess[k1][l1] / 10 == chess[i1][j1] / 10;		//기물식별
                                   chess[k1][l1] % 10 == chess[i1][j1] % 10;		//피아식별
                                   chess[i1][j1] / 10 == chess[i1][j1] % 10 ==' ';    // 0, 1
                                   }
             ...
             { case '2':/***CHECKS WHETHER KNIGHT IS THERE OR NOT******/
                       {     
                             ...
                             {/*******FOR VERTICAL MOVEMENT*************/
                                        if(chess[i1][j1] % 10 == chess[k1][l1] % 10 )
                                        {
                                            q =1;
                                            if(cond == 0)
       ...
       case'7':/***************************************RULE OF QUEEN ****************************************/
             switch(chess[i1][j1] / 10)/***CHECKS WHETHER QUEEN IS THERE OR NOT******/
                 { case'7':
                           {
         ...
         if(i==2)
         {
              ...
              for(len; len>0; len--)
              {
                  ...
                  if( (hor+vert)%2 == 0 )
                  {
                      if(chp[a][b] % 10 == '1') // 1
                      {
                       printf("   \x1b[31m%c\x1b[0m   ", chp[a][b] / 10); // 0                   /*unicode*/
                      }
                      ...
                      if(chp[a][b] % 10 == '2') // 1
                      {
                       printf("   \x1b[32m%c\x1b[0m   ", chp[a][b] / 10); //0                  /*unicode*/
                      }
                  }
                  ...
                  else if( (hor+vert)%2 != 0 )
                  {
                      if(chp[a][b] % 10 =='1') // 1
                      {
                       printf("\u2588\u2588\u258C\x1b[31m%c\x1b[0m\u2590\u2588\u2588", chp[a][b] / 10); // 0
                      }

                      if(chp[a][b] % 10 =='2') // 1
                      {
                       printf("\u2588\u2588\u258C\x1b[32m%c\x1b[0m\u2590\u2588\u2588", chp[a][b] / 10); // 0
                      }
